...
import { Animated, DeviceEventEmitter, StyleSheet, Text, TouchableOpacity, View, AsyncStorage } from 'react-native';
...
export default class DeckView extends React.Component {
    constructor(props) {
        ...
        this.state = {opacity: new Animated.Value(0), decks: [], deck: this.props.navigation.state.params.deck};
    }
    ...
    addCard() {
        this.props.navigation.navigate('NewCard', {deck: this.props.navigation.state.params.deck})
    }
    ...
    render() {
        ...
        return (
            <View style={{flex: 1}}>
                <Animated.Text style={{textAlign: 'center', fontSize: 30, margin: 20, opacity}}>
                    {deck.name}
                </Animated.Text>
                <Animated.Text style={{textAlign: 'center', fontSize: 20, margin: 10, opacity}}>
